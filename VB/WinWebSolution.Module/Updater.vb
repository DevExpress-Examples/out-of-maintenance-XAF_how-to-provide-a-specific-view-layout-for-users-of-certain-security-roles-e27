...
Namespace WinWebSolution.Module
	Public Class Updater
		...
		Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
			...
			user1.Save()
			user2.Save()
			If Session.FindObject(Of Task)(CriteriaOperator.Parse("Subject == 'Fix breakfast'")) Is Nothing Then
				Dim task As New Task(Session)
				...
				task.Save()
			End If
			If Session.FindObject(Of Task)(CriteriaOperator.Parse("Subject == 'Task1'")) Is Nothing Then
				Dim task As New Task(Session)
				task.Subject = "Task1"
				task.AssignedTo = user1
